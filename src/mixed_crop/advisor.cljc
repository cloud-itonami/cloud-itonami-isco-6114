(ns mixed-crop.advisor
  "CropAdvisor — proposes a mixed-crop-growing operation (tend step,
  harvest entry, operation near buyers/visitors on-site, treatment
  application near a water source) for a registered plot. The advisor
  ...
  provenance or visitor/treatment risk; `mixed-crop.governor` is the
  independent system that decides whether the proposal may proceed,
  per the itonami actor pattern.

  A proposal is a map:
    {:op :tend|:harvest|:operate-near-buyers-visitors|:treatment-application-near-water
...
(def ^:private system-prompt
  "You are a mixed-crop-growing advisor. Given a tend or harvest
